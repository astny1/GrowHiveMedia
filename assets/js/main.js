...
(function() {
  ...
  /**
   * About Section Video Overlay and Controls
   */
  ...
  if (aboutVideo && videoOverlay && videoContainer) {
    // Ensure inline playback on iOS (avoid forced fullscreen)
    ...
    // Also handle direct clicks on video if paused
    ...
    // Hide controls and show overlay again when video ends,
    // but avoid reloading the source so it replays instantly on mobile
